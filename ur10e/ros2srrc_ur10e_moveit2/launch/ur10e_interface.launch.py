...
# ur10e_interface.launch.py:
# Launch file for the UR10e Robot GAZEBO + MoveIt!2 SIMULATION (+ Robot/Gripper triggers) in ROS2 Humble:
...
def generate_launch_description():
    ...
    print("")
    print("===== Universal Robots - UR10e: Robot Simulation (ros2srrc_ur10e_moveit2) =====")
