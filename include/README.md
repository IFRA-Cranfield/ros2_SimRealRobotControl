...
The original move_group_interface.h header file is included in the /opt/ros/jazzy/include/moveit_ros_planning_interface/moveit/move_group_interface folder on your Ubuntu 24.04 machine (if MoveIt!2 has been installed). This folder has restricted access, thus the following steps must be followed to paste the move_group_interface_improved.h file into that path:
...
2. Once the installation finishes, Nautilus must be restarted:
    ...
    nautilus -q
    ```
3. Open the /opt/ros/jazzy/include/moveit_ros_planning_interface/moveit/move_group_interface folder -> Right click -> Open as administrator.
