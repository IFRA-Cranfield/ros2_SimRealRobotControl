...
# moveit2.launch.py:
# Launch file for the UR3 Robot BRINGUP + MoveIt!2 Framework in ROS2 Humble:
...
def GetCONFIG(CONFIGURATION):
    ...
    PATH = os.path.join(os.path.expanduser('~'), 'dev_ws', 'src', 'ros2_SimRealRobotControl', 'packages', 'ur3')
...
def generate_launch_description():
    ...
    # ========== CELL INFORMATION ========== #
    print("")
    print("===== ABB UR3: Robot Bringup + MoveIt!2 Framework (ros2srrc_ur3_bringup) =====")
    ...
    xacro_file = os.path.join(ur3_description_path,'urdf',CONFIGURATION["urdf"])
    ...
    # ros2_control:
    ros2_controllers_path = os.path.join(get_package_share_directory("ros2srrc_robots"), "ur3", "config", "controller_ur.yaml")
    ...
    if EE == "false":
        robot_description_semantic_config = load_file("ros2srrc_ur3_moveit2", "config/ur3.srdf")
    else:
        robot_description_semantic_config = load_file("ros2srrc_ur3_moveit2", "config/ur3" + CONFIGURATION["ee"] + ".srdf")
    
    robot_description_semantic = {"robot_description_semantic": robot_description_semantic_config}

    # Kinematics.yaml file:
    kinematics_yaml = load_yaml("ros2srrc_robots", "ur3/config/kinematics.yaml")
    ...
    pilz_cartesian_limits_yaml = load_yaml("ros2srrc_robots", "ur3/config/pilz_cartesian_limits.yaml")
    pilz_cartesian_limits = {'robot_description_planning': pilz_cartesian_limits_yaml}

    # MoveIt!2 Controllers:
    moveit_simple_controllers_yaml = load_yaml("ros2srrc_robots", "ur3/config/controller_moveit2.yaml")
    ...
    if EE == "false":
        ...
        rviz_full_config = os.path.join(rviz_base, "ur3" + CONFIGURATION["ee"] + "_moveit2.rviz")
    ...
    if EE == "false":
        ...
        MoveInterface = Node(
            ...
            executable="move",
            output="screen",
            parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"ROB_PARAM": "ur3"}, {"EE_PARAM": "none"}, {"ENV_PARAM": "bringup"}],
        )
        ...
        MoveInterface = Node(
            ...
            executable="move",
            output="screen",
            parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"ROB_PARAM": "ur3"}, {"EE_PARAM": CONFIGURATION["ee"]}, {"ENV_PARAM": "bringup"}],
        )
        SequenceInterface = Node(
            name="sequence",
            package="ros2srrc_execution",
