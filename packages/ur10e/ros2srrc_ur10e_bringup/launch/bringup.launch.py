...
# moveit2.launch.py:
# Launch file for the UR10e Robot BRINGUP + MoveIt!2 Framework in ROS2 Humble:
...
def generate_launch_description():
    ...
    # ========== CELL INFORMATION ========== #
    print("")
    print("===== ABB UR10e: Robot Bringup + MoveIt!2 Framework (ros2srrc_ur10e_bringup) =====")
    ...
    # ros2_control:
    ros2_controllers_path = os.path.join(get_package_share_directory("ros2srrc_robots"), "ur10e", "config", "controller_ur.yaml")
    ...
    if EE == "false":
        ...
        MoveInterface = Node(
            ...
            executable="move",
            output="screen",
            parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"ROB_PARAM": "ur10e"}, {"EE_PARAM": "none"}, {"ENV_PARAM": "bringup"}],
        )
        ...
        MoveInterface = Node(
            ...
            executable="move",
            output="screen",
            parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"ROB_PARAM": "ur10e"}, {"EE_PARAM": CONFIGURATION["ee"]}, {"ENV_PARAM": "bringup"}],
        )
        SequenceInterface = Node(
            name="sequence",
            package="ros2srrc_execution",
    ...
    RobMoveInterface = Node(
        ...
        executable="robmove",
        output="screen",
        parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"ROB_PARAM": "ur10e"}],
    )
