...
# moveit2.launch.py:
# Launch file for the UR5 Robot GAZEBO SIMULATION + MoveIt!2 Framework in ROS2 Humble:
...
def generate_launch_description():
    ...
    # ========== CELL INFORMATION ========== #
    print("")
    print("===== UR5: Robot Simulation + MoveIt!2 Framework (ros2srrc_ur5_moveit2) =====")
    ...
    if EE == "false":
        ...
        YAML_ROB = load_yaml("ros2srrc_robots", "ur5/config/joint_limits.yaml")["joint_limits"]
    ...
    if EE == "false":
        ...
        YAML_ROB = load_yaml("ros2srrc_robots", "ur5/config/controller_moveit2.yaml")
    ...
    if EE == "false":
        ...
        MoveInterface = Node(
            ...
            executable="move",
            output="screen",
            parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"use_sim_time": True}, {"ROB_PARAM": "ur5"}, {"EE_PARAM": CONFIGURATION["ee"]}, {"ENV_PARAM": "gazebo"}],
        )
        SequenceInterface = Node(
            name="sequence",
            package="ros2srrc_execution",
    ...
    RobMoveInterface = Node(
        ...
        executable="robmove",
        output="screen",
        parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"use_sim_time": True}, {"ROB_PARAM": "ur5"}],
    )
