...
In ros2_SimRealRobotControl, individual Robot Movements contained in a single ROS 2 Node (ROS 2 Action Server, move.cpp), and are executed by calling a single action, called, "Move".
