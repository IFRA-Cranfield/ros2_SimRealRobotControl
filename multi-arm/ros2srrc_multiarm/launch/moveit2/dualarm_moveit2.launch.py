...
def generate_launch_description():
    ...
    robot_description_kinematics_1 = {"robot_description_kinematics": kinematics_yaml_1}
    ...
    robot_description_kinematics_2 = {"robot_description_kinematics": kinematics_yaml_2}
    ...
    robot_description_planning_1 = {
        "robot_description_planning": {
            **(joint_limits_yaml_1 or {}),
            **(pilz_cartesian_limits_yaml_1 or {}),
        }
    }
    robot_description_planning_2 = {
        "robot_description_planning": {
            **(joint_limits_yaml_2 or {}),
            **(pilz_cartesian_limits_yaml_2 or {}),
        }
    }
    ...
    if EE_1 == "true":
        MoveInterface_1 = Node(
            ...
            parameters=[robot_description,
                        ...
                        {"EE_CONTROLLER_NAMES": ["/" + CONFIGURATION["ROB1_id"] + "_" + x for x in CONTROLLERS_1]},
                        {"EE_CONTROLLER_ACTION_NAMESPACES": ["gripper_cmd"] * len(CONTROLLERS_1)},
    ...
    if EE_2 == "true":
        MoveInterface_2 = Node(
            ...
            parameters=[robot_description,
                        ...
                        {"EE_CONTROLLER_NAMES": ["/" + CONFIGURATION["ROB2_id"] + "_" + x for x in CONTROLLERS_2]},
                        {"EE_CONTROLLER_ACTION_NAMESPACES": ["gripper_cmd"] * len(CONTROLLERS_2)},
